...
FREE_MODELS={"chat":["google/gemma-4-31b-it:free","openai/gpt-oss-120b:free","openai/gpt-oss-20b:free","nvidia/nemotron-3-ultra-550b-a55b:free","nvidia/nemotron-3-super-120b-a12b:free","meta-llama/llama-3.2-3b-instruct:free","openrouter/free"],"code":["poolside/laguna-m.1:free","poolside/laguna-xs.2:free","cohere/north-mini-code:free","qwen/qwen3-coder:free"],"vision":["nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free","nvidia/nemotron-nano-12b-v2-vl:free"],"tools":["nvidia/nemotron-3-ultra-550b-a55b:free"]}
class OpenRouterService:
    def __init__(self):
        self.api_key=os.getenv("OPENROUTER_API_KEY","");self.base_url=os.getenv("OPENROUTER_BASE_URL","https://openrouter.ai/api/v1");self.default_model=os.getenv("OPENROUTER_DEFAULT_MODEL","google/gemma-4-31b-it:free");self.default_code_model=os.getenv("OPENROUTER_CODE_MODEL","qwen/qwen3-coder:free");self.client=AsyncOpenAI(api_key=self.api_key,base_url=self.base_url) if self.api_key else None
